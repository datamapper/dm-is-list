...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dm-adjust>, ["~> 1.0.0.rc1"])
      s.add_runtime_dependency(%q<dm-transactions>, ["~> 1.0.0.rc1"])
      s.add_development_dependency(%q<rspec>, ["~> 1.3"])
    else
      s.add_dependency(%q<dm-core>, ["~> 1.0.0.rc1"])
      s.add_dependency(%q<dm-adjust>, ["~> 1.0.0.rc1"])
      s.add_dependency(%q<dm-transactions>, ["~> 1.0.0.rc1"])
