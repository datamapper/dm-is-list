...
Gem::Specification.new do |s|
  ...
  s.date = "2011-10-09"
  s.description = "DataMapper plugin for creating and organizing lists"
  ...
  s.homepage = "http://github.com/datamapper/dm-is-list"
  s.require_paths = ["lib"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.3.0.beta') then
      s.add_runtime_dependency(%q<dm-adjust>, ["~> 1.3.0.beta"])
      s.add_development_dependency(%q<jeweler>, ["~> 1.6.4"])
      s.add_development_dependency(%q<rake>, ["~> 0.9.2"])
      s.add_development_dependency(%q<rspec>, ["~> 1.3.2"])
    else
      s.add_dependency(%q<dm-adjust>, ["~> 1.3.0.beta"])
